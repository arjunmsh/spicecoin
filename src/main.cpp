...
const string strMessageMagic = "SpiceCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SpiceCoin
    bool fStrictPayToScriptHash = true; // Always active in SpiceCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SpiceCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "September 22, 2016, Arjun Mishra builds spicecoin.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("39f86f700fe1a27779b35bed8d598aced8d3e0649d56fbae7a9dbf1818600b04"));
